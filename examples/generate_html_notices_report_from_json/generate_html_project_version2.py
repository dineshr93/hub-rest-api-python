...
def addHomepageURL(jsonInput):
    ...
    fileContent = jsonInput['reportContent'][0]['fileContent']
    ...
    for bom_component in bom_components:
        ...
        for componentLicense in componentLicenses:
            if componentLicense["component"]["projectName"] == bom_component['componentName'] and componentLicense["component"]["versionName"] == bom_component['componentVersionName']:
                componentLicense["homepage"]={"component_home_page": component_details.get("url"),"additional_home_pages": component_details.get("additionalHomepages"),}
                for componentCopyrightText in componentCopyrightTexts:
        ...
        if response.status_code == 200:
            if report_format == "TEXT":
                ...
                with open(filename, "w") as f:
                    response=addHomepageURL(response.json())
