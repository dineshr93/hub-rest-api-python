...
for i,user in enumerate(bd.get_resource("users"),1):
    ...
    if ll_obj.get('lastLogin'):
        ...
        print(f"{i} {user['userName']}, First Name: {user['firstName']}, Last Name: {user['lastName']}, Active: {user['active']}, Email: {user['email']}, last login: '****No lastLogin****'")

    # print(f"{i} {user['userName']}, First Name: {user['firstName']}, Last Name: {user['lastName']}, Active: {user['active']}, Email: {user['email']}")
